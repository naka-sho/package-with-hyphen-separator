...
public class SkipPartitionedWithPostgresTablesPlugin extends PluginAdapter {
    ...
    public void setProperties(Properties properties) {
        ...
        String ciProp = properties.getProperty("caseInsensitive", "false");
        if ("true".equals(ciProp)) {
        ...
        try {
            String schemaName = properties.getProperty("schemaname", "public");
            this.allowlist = discoverNonPartitionedTables(schemaName);
